...
public class InsertRandomSpeedTest {
    ...
    */
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            timeRandomMap61B(new HashMap<String, Integer>(),
                            waitForPositiveInt(input), L);

            System.out.print("\nEnter # strings to insert into Java's HashMap: ");
            timeRandomHashMap(new java.util.HashMap(),
                            waitForPositiveInt(input), L);
    ...
    /** Returns time needed to put N random strings of length L into the
      * HashMap hashMap. */
    public static double insertRandom(java.util.HashMap hashMap, int N, int L) {
        Stopwatch sw = new Stopwatch();
        String s = "cat";
        for (int i = 0; i < N; i++) {
            s = StringUtils.randomString(L);
    ...
    */
    ...
    /*
        ...
        Prints a nice message about the error
    */
    public static void timeRandomHashMap(java.util.HashMap hashMap, int N, int L) {
        try {
